...
export default function MaintenancePage() {
  ...
  useEffect(() => {
    ...
    const initVanta = () => {
      if (destroyed || vantaEffect.current) return;
    ...
    const loadScripts = () => {
      ...
      if (!document.getElementById("three-script")) {
        ...
        threeScript.onload = () => {
          // Then load Vanta
          if (!document.getElementById("vanta-script")) {
      ...
      } else if (!document.getElementById("vanta-script")) {
        const vantaScript = document.createElement("script");
        vantaScript.id = "vanta-script";
        vantaScript.src = "https://cdn.jsdelivr.net/npm/vanta@0.5.24/dist/vanta.globe.min.js";
        vantaScript.onload = initVanta;
        ...
        // Both scripts already exist, just try to init
        initVanta();
      }
    };
